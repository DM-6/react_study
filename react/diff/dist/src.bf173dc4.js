    ...
    if (/on\w+/.test(name)) {
        ...
        if (!value || typeof value === 'string') {
            ...
            for (var _name in value) {
                dom.style[_name] = typeof value[_name] === 'number' ? value[_name] + 'px' : value[_name]; // 驼峰式命名 如 fontSize
            }
        }
    } else {
        if (name in dom) {
...
function renderComponent(component) {
    ...
    var renderer = component.render(); // 调用render方法
...
function createComponent(component, props) {
    ...
    if (component.prototype && component.prototype.render) {
        ...
        inst = new _component2.default(props); // 没有构建组件时将Component拿出来
...
},{"./react":"src\\react\\index.js","./react-dom":"src\\react-dom\\index.js"}],"C:\\Users\\LiuJun\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/src.bf173dc4.map